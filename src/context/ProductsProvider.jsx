...
const reducer = (state, action) => {
    switch (action.type) {
        ...
        case "CHANGE":
            ...
            const newProduct = {
                ...state.products[id],
                count: state.chosenProducts[id]
                    ? state.chosenProducts[id].count + count
                    : 1,
            };
        ...
        case "FILTER":
            console.log({ filter: action.payload,products: state.products });
        ...
        case "RELOAD":
            return {
                ...state,
                ...action.payload,
                chosenProducts: { ...action.payload.chosenProducts },
            };
        default:
